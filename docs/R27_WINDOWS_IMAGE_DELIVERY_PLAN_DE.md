...
Verträge sind erstellt. Nächster Schritt ist der saubere Zwei-Build-Lauf der
drei Images mit vollständiger lokaler Security-/Artefaktevidenz. Danach bleibt
G3 bis zu einem freigegebenen privaten GHCR-Staging-Push geschlossen. Vor
diesem Push ist eine weitere ausdrückliche Product-Owner-Freigabe erforderlich.
